...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\anhthe.JPG"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.groupBox.setStyleSheet("background-color: rgb(236, 255, 199); color: black;")
        ...
        self.pushButtonRemove.setStyleSheet("background-color: rgb(255, 170, 255); color: black;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\bin.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pushButtonInsert.setStyleSheet("background-color: rgb(255, 170, 255); color: black;")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\diskette.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pushButtonNew.setStyleSheet("background-color: rgb(255, 170, 255); color: black;")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\plus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pushButtonUpdate.setStyleSheet("background-color: rgb(255, 170, 255); color: black;")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\refresh.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.groupBox_2.setStyleSheet("background-color: rgb(255, 201, 243); color: black;")
        ...
        self.lineEditName.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
        ...
        self.lineEditAge.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
        ...
        self.lineEditCode.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
        ...
        self.lineEditIntro.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
...
"border-color: rgb(85, 85, 0);")
        ...
        self.labelAvatar.setPixmap(QtGui.QPixmap("C:\\Users\\Hoang Anh\\Downloads\\01_Study\\stu_7th_semester_nam3\\02_MachineLearning\\05_projects\\01_10\\images\\anh_depJPG.JPG"))
        ...
        self.pushButtonAvatar.setStyleSheet("background-color: rgb(170, 255, 127); color: black;")
        ...
        self.lineEditId.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
        ...
        self.pushButtonRemoveAvatar.setStyleSheet("background-color: rgb(170, 255, 127); color: black;")
        ...
        self.groupBox_3.setStyleSheet("background-color: rgb(251, 255, 206); color: black;")
        self.groupBox_3.setObjectName("groupBox_3")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.groupBox_3)
        self.verticalLayout.setObjectName("verticalLayout")
        self.tableWidgetStudent = QtWidgets.QTableWidget(parent=self.groupBox_3)
        self.tableWidgetStudent.setStyleSheet("background-color: rgb(207, 255, 235); color: black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Nguyễn Hoàng Anh - Student Management"))
